...
function genPass() {
  var newPass = []; //empties array for generation
  ...
  if (passLength < 8 || passLength > 128) {
    newPassBox.innerHTML = '<div>CAUGHT ERROR - CHOOSE A VALUE BETWEEN |8| AND |32|</div>'; //error message displays in newPassBox
  } else {
